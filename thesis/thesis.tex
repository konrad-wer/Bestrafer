...
\subsection*{Extension of Dunfield's and Krishnaswami's system}
...
Bestrafer uses extended version of Dunfield's and Krishnaswami's bidirectional type system introduced in the article
...
\inferrule{typeName_{constrName} = typeName \\
  ...
  \Leftarrow (typeName \; \rho_1 \, \rho_2 \, \dots \, \rho_n) \; p \dashv \Delta_k}
\end{mathpar}
