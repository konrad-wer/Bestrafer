...
do not have to be packaged within another datatype; instead they can be used like any other type constructor.
...
to minize boilerplate type annotations and produce better quality typechecking errors. Following
