...
\let\lll\undefined
\usepackage{mathtools, array, amsfonts, mathpartir, amssymb}
...
Polymorphhic types are treated like any other big type so they can be nested in each ohter arbitrarily
...
\subsection*{Template constructors}
...
\begin{grammar}{A,B,C\Coloneqq}{}
  ...
  \mid A \wedge  P                      & asserting type\\
  \mid \textit{Type identifier } \rho_1  \rho_2  \dots \rho_n              & user defined GADT \\
  \mid \textit{parameter index}         & index of GADT parameter
\end{grammar}

\subsection*{Functional constructors}
